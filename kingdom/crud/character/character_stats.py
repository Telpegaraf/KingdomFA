...
from kingdom.schemas.character.character_stats import CharacterStatsCreate, CharacterStatsUpdate
from kingdom.models.character import CharacterStat, Character
