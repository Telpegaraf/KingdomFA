...
from kingdom.schemas.character.character_skill_mastery import CharacterSkillMasteryCreate, CharacterSkillMasteryUpdate
from kingdom.models.character import CharacterSkillMastery, Character
